...
def test_create_offer_signs_private_request() -> None:
    ...
    def fake_transport(method: str, url: str, **kwargs: Any) -> list[Any]:
        ...
        row = [123, "fUSD", 0, 0, "50", "50", "LIMIT", None, None, 0, "ACTIVE", None, None, None, "0.0002", 2]
    ...
    offer = client.create_funding_offer(
        CreateFundingOfferRequest(symbol="fUSD", amount=Decimal("50"), rate=Decimal("0.0002"), period=2)
    )
